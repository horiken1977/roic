    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-2xl font-bold text-gray-900">企業検索・ROIC分析</h1>
          <div className="flex gap-2">
            <button
              onClick={() => setUseEDINET(true)}
        ...
        <div className="text-sm text-gray-600">
          {useEDINET 
            ? 'EDINET APIから実際の企業データと財務情報を取得してROIC分析を行います（デモ環境ではサンプルデータを使用）'
            : 'あらかじめ用意されたサンプル企業データでROIC分析を体験できます'
          }
        </div>
      </div>
      ...
      {useEDINET ? (
        ...
        <>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-gray-900">サンプル企業検索</h2>
              <button
