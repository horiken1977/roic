...
/**
 * EDINET API プロキシクライアント
 * 
 * 注意: 直接EDINET APIを呼び出すとCORSエラーが発生するため、
 * 実際の本番環境では独自のプロキシサーバーが必要です。
 * ここではデモ用のサンプルデータを返します。
 */
class EDINETApiClient {
  private baseUrl: string;
  private apiKey?: string;

  constructor(baseUrl: string = 'https://api.edinet-fsa.go.jp/api/v2', apiKey?: string) {
  ...
  async searchCompanies(query: string): Promise<EDINETApiResponse<EDINETCompany[]>> {
    // 実際のEDINET APIではCORSの問題があるため、サンプルデータを返す
    try {
      ...
      return {
        success: true,
        data: filtered,
        message: `${filtered.length}件の企業が見つかりました`
      };
    } catch (error) {
      return {
        success: false,
        error: 'EDINET API検索エラー',
    ...
    try {
      ...
      const companyBaseData: Record<string, Partial<FinancialDataFromEDINET>> = {
        'E02144': { // トヨタ自動車
          ...
          netSales: 31379500,
          grossProfit: 5980000,
          operatingIncome: 2725000,
          interestIncome: 95000,
          sellingAdminExpenses: 3255000,
          totalAssets: 53713000,
          cashAndEquivalents: 4885000,
          shareholdersEquity: 23913000,
          interestBearingDebt: 8826000,
        ...
        'E02513': { // ソニーグループ
          ...
          netSales: 12974000,
          grossProfit: 4200000,
          operatingIncome: 1308000,
          interestIncome: 45000,
          sellingAdminExpenses: 2892000,
          totalAssets: 24166000,
          cashAndEquivalents: 1820000,
          shareholdersEquity: 6835000,
          interestBearingDebt: 3244000,
          accountsPayable: 1400000,
        ...
        'E03568': { // 三菱UFJ
          companyName: '三菱UFJフィナンシャル・グループ',
          netSales: 5645000, // 銀行業では経常収益
          grossProfit: 3200000,
          operatingIncome: 1245000,
          interestIncome: 1850000,
          sellingAdminExpenses: 1955000,
          totalAssets: 362436000,
          cashAndEquivalents: 48200000,
          shareholdersEquity: 15485000,
          interestBearingDebt: 12800000, // 銀行業では預金等
          accountsPayable: 5600000,
          accruedExpenses: 2400000,
          leaseExpense: 85000,
          leaseDebt: 740000,
          taxRate: 0.25
        },
        'E03562': { // ファーストリテイリング
          ...
          netSales: 2757000,
          grossProfit: 1388000,
          operatingIncome: 465000,
          interestIncome: 12000,
          sellingAdminExpenses: 923000,
          totalAssets: 1849000,
          cashAndEquivalents: 689000,
          shareholdersEquity: 1063000,
          interestBearingDebt: 245000,
        ...
        'E02282': { // キーエンス
          ...
          interestIncome: 8000,
          sellingAdminExpenses: 293000,
          totalAssets: 1205000,
          cashAndEquivalents: 512000,
          shareholdersEquity: 935000,
